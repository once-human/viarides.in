...
// Updated Instagram Icon (Simpler glyph)
const InstagramIcon = () => (
...
const LinkedInIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5" aria-hidden="true">
    <path d="M20.5 2h-17A1.5 1.5 0 002 3.5v17A1.5 1.5 0 003.5 22h17a1.5 1.5 0 001.5-1.5v-17A1.5 1.5 0 0020.5 2zM8 19H5v-9h3zM6.5 8.25A1.75 1.75 0 118.3 6.5 1.78 1.78 0 016.5 8.25zM19 19h-3v-4.74c0-1.42-.6-1.93-1.38-1.93-.91 0-1.38.61-1.38 1.93V19h-3v-9h2.9v1.3a3.11 3.11 0 012.7-1.4c1.55 0 3.38 1.02 3.38 3.54V19z"/>
  </svg>
);

// Updated Mail Icon (Standard envelope outline)
const MailIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5" aria-hidden="true">
...
export default function Home() {
  ...
  return (
    ...
    <div className="relative flex flex-col items-center justify-center min-h-screen overflow-hidden overflow-x-hidden bg-gradient-to-br from-gray-900 to-black text-gray-100 font-[family-name:var(--font-geist-sans)]">
      ...
      >
        <a href="https://www.instagram.com/viarides.in/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-200 transition-colors" aria-label="Instagram">
          <InstagramIcon />
        </a>
        <a href="https://www.linkedin.com/company/via-rides" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-200 transition-colors" aria-label="LinkedIn">
          <LinkedInIcon />
        </a>
        <a href="mailto:hello@viarides.in" className="text-gray-400 hover:text-gray-200 transition-colors" aria-label="Email">
          <MailIcon />
        </a>
      </motion.div>
